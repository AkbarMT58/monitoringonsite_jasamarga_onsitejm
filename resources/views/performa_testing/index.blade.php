        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch card-height border-none">
                <div class="card-body p-0 mt-lg-2 mt-0">
                    ...
                    <p class="mb-0 mr-4">Dashboard Performa Testing </p>
                    <div class="row">

                    <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Link Performa Testing" href="{{route('performa_index')}}">Performa Testing Disini <i class="ri-time-line"></i>
                                    </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 card-total-sale">
                                <div class="icon iq-icon-box-2 bg-info-light">
                                    <img src="../assets/images/product/good.png" class="img-fluid" alt="image">
                                </div>
                                <div>
                                    <p class="mb-2">Very Good</p>
                                    <h4> {{ $total_paid }} x</h4>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 card-total-sale">
                                <div class="icon iq-icon-box-2 bg-success-light">
                                    <img src="../assets/images/product/down.png" class="img-fluid" alt="image">
                                </div>
                                <div>
                                    <p class="mb-2">Down</p>
