            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Create Transfer Knowledge</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                                <label for="name"> Bahasa Pemograman <span class="text-danger">*</span></label>
                                 ...
                                 <input type="text"  name="bahasa_pemograman" id="bahasa_pemograman" class="form-control" />
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                               ...
                               <div class="col-md-12">
                                 ...
                                 <input type="text" class="form-control"  id="framework" name="framework"></input>
                               ...
                               <div class="col-md-12">
                                 ...
                                 <textarea type="text" class="form-control" style="height:200px;" id="catatan" name="catatan"></textarea>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <a type="submit" onclick="Simpan_TK()" class="btn btn-primary mr-2">Save</a>
...
function getDateTime() {
    ...
    function Simpan_TK(){
       ...
       const files_1 = document.querySelector('#file_1');
       const files_2 = document.querySelector('#file_2');
       const data_input = new FormData();

       let file_tk_1 = files_1.files;
       let file_tk_2 = files_2.files;

       console.log("lihat file 1:",file_tk_1[0]);
       console.log("lihat file 2:",file_tk_2[0]);
        ...
        data_input.append('dokumen_link_1', file_tk_1[0]);
        data_input.append('dokumen_link_2', file_tk_2[0]);
        data_input.append('catatan',document.getElementById('catatan').value);
        data_input.append('framework',document.getElementById('framework').value);
        data_input.append('keterangan',document.getElementById('keterangan').value);
        data_input.append('status_tk',document.getElementById('status_tk').value);
        data_input.append('bahasa_pemograman',document.getElementById('bahasa_pemograman').value);
        data_input.append('tanggal_cetak',document.getElementById('akses').value);
    ...
    $.ajax({
        ...
        success: function(response){
                ...
                if(response.status=='200'){
                    ...
                    toastr.success('Data TK  Sukses Tersimpan!.Terima Kasih',{ fadeAway: 3000 });

                    location.href="index";

                    console.log("lihat data tk:",response);
