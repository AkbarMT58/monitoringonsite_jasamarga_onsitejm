        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch card-height border-none">
                <div class="card-body p-0 mt-lg-2 mt-0">
                    <h3 class="mb-3"> </h3>
                    <p class="mb-0 mr-4">Dashboard ZAP </p>
                    <div class="row">

                    <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Link ZAP " href="{{route('zap_index')}}">ZAP Disini <i class="ri-time-line"></i>
                                    </a>
