    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
             ...
             <form action="{{ route('webjm.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    @foreach($daftarwebjm as $data_webjm)
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Edit Daftar Web JM</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="id" name="id" value="{{$data_webjm->id}}"  hidden />
                              
                                 <input type="text" class="form-control" id="nama_web" name="nama_web" value="{{$data_webjm->name_web}}"  placeholder="Nama Web" required/>
                            ...
                            <div class="form-group col-md-12">
                                <label for="nama_database">Nama Database <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control" id="nama_database" name="nama_database" value="{{$data_webjm->name_database }}"  placeholder="Nama Database" required/>
                            ...
                            <div class="form-group col-md-12">
                               ...
                               <input type="text" class="form-control" id="nama_host" name="nama_host" value="{{ $data_webjm->host }}"   placeholder="Nama Host" required/>
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" id="port" name="port"  placeholder="Isi Port " value="{{$data_webjm->port}}"  required/>
                             ...
                             <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" id="username" name="username"  value="{{$data_webjm->username}}" placeholder="Isi Username "  />
                             ...
                             <div class="form-group col-md-12">
                              ...
                              <input type="password" class="form-control" id="nama_password" name="nama_password" value="{{$data_webjm->password}}"  placeholder="Isi Password "   onfocus="this.removeAttribute('readonly');" />
