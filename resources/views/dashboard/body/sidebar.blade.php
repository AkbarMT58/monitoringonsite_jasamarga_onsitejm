...
<div class="iq-sidebar sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard') }}" class="header-logo">
            <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">Monitoring Security JM</h5>
        </a>
    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ Request::is('pos*') ? 'active' : '' }}" hidden >
                ...
                <li>
                    <a href="#orders" class="collapsed" data-toggle="collapse" aria-expanded="false" hidden >
                ...
                <li>
                    ...
                    <ul id="permission" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                     ...
                     <ul id="permission" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                        <li class="{{ Request::is(['permission', 'permission/create', 'permission/edit/*']) ? 'active' : '' }}">
                        <a href="{{ route('signatures') }}" class="svg-icon">
                        <i class="fa-solid fa-users"></i>
                ...
                <li class="{{ Request::is('customers*') ? 'active' : '' }}" hidden>
                ...
                <li class="{{ Request::is('suppliers*') ? 'active' : '' }}" hidden>
                ...
                <li>
                    <a href="#advance-salary" class="collapsed" data-toggle="collapse" aria-expanded="false" hidden>
                ...
                <li>
                    <a href="#securityweb" class="collapsed" data-toggle="collapse" aria-expanded="false">
                    <i class="ri-shield-keyhole-line"></i>
                        <span class="ml-3">Security Web</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="securityweb" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">

                        <li class="{{ Request::is(['performatesting']) ? 'active' : '' }}">
                            <a href="{{ route('performatesting') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>Performa Testing</span>
                            </a>
                        </li>
                        <li class="{{ Request::is('zap') ? 'active' : '' }}">
                            <a href="{{ route('zap') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>ZAP</span>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <i class="ri-time-line"></i>
                        <span class="ml-3">HR(Human Resource)</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="attendence" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                        ...
                        <li class="{{ Request::is(['employee/attendence']) ? 'active' : '' }}">
                            <a href="{{ route('attendence.index') }}">
                                <i class="fa-solid fa-arrow-right"></i><span onclick="refresh_page_absen()" >Absen Kehadiran</span>
                            </a>
                        </li>
                        <li class="{{ Request::is(['cuti']) ? 'active' : '' }}">
                            <a href="{{ route('cuti') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>Cuti Tahunan</span>
                            </a>
                        </li>
                         <li class="{{ Request::is('timesheet') ? 'active' : '' }}">
                            <a href="{{ route('timesheet') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>Time Sheet</span>
                            </a>
                        </li>
                          <li class="{{ Request::is('timesheet') ? 'active' : '' }}">
                            <a href="{{ route('timesheet') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>Sharing Document</span>
                            </a>
                        </li>
                    </ul>
                </li>
                 ...
                 <!-- <li>
                    <a href="#annualleave" class="collapsed" data-toggle="collapse" aria-expanded="false">
                    <i class="ri-time-line"></i>
                        <span class="ml-3">Cuti Tahunan</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="annualleave" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">

                        <li class="{{ Request::is(['cuti']) ? 'active' : '' }}">
                            <a href="{{ route('cuti') }}">
                                <i class="fa-solid fa-arrow-right"></i><span onclick="refresh_page_absen()" >List Cuti Tahunan </span>
                            </a>
                        </li>
                   ...
                   <li>
                    ...
                    <i class="ri-time-line"></i>
                        <span class="ml-3">Time Sheet Work</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    </a>
                    <ul id="timesheet" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">

                        <li class="{{ Request::is(['cuti']) ? 'active' : '' }}">
                            <a href="{{ route('cuti') }}">
                                <i class="fa-solid fa-arrow-right"></i><span onclick="refresh_page_absen()" >List Time Sheet</span>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul id="permission" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                        ...
                        <li class="{{ Request::is(['role/permission*']) ? 'active' : '' }}">
                            <a href="{{ route('users.index') }}">
                                <i class="fa-solid fa-arrow-right"></i><span>Pengguna</span>
                            </a>
                        </li>
                    ...
                    <a href="{{ route('backup.index') }}" >
                        ...
                        <i class="fa-solid fa-arrow-right"></i><span>Backup Database</span>
                    </a>
                   </li>
